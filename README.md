...
# ✅ 1️⃣ GitHub Badges (Add at TOP of README)
...
# 🏗️ 2️⃣ Architecture Diagram (Text + Mermaid)

### 📌 High-Level System Architecture

```mermaid
flowchart TD
    A[User Uploads PDFs] --> B[Text Extraction<br/>PyPDF2 / pdfplumber]
    B --> C[Chunking Engine<br/>RecursiveCharacterTextSplitter]
    C --> D[Embedding Generator]
    D -->|Google| E1[Google Embeddings]
    D -->|OpenAI| E2[OpenAI Embeddings]
    D -->|Local| E3[Hash Embeddings]
    ...
    G --> H[Prompt Template]
    H --> I[LLM Engine]
    I -->|Gemini| J1[Gemini 1.5 Flash]
    I -->|OpenAI| J2[GPT-4o-mini]
    J1 --> K[Answer + Citations]
    J2 --> K
    K --> L[Streamlit UI<br/>Compare | Export | Analyze]
```

📌 **Tip:** GitHub automatically renders Mermaid diagrams.
